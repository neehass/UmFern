...
png(file.path(output,  paste0("wpi_interpolate_forward.png")), height = 800, width = 800)
...
png(file.path(output,  paste0("F_interpolate",".png")), height = 200, width = 200)
...
png(file.path(output,  paste0("P_interpolate",".png")), height = 200, width = 200)
